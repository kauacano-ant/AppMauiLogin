...
public partial class Adidas : ContentPage
{
    ...
    private async void adidas2_Clicked(object sender, EventArgs e)
    {
        await Navigation.PushAsync(new Adidas2());
    }

    private async void adidas3_Clicked(object sender, EventArgs e)
    {
        await Navigation.PushAsync(new Adidas3());
    }
}
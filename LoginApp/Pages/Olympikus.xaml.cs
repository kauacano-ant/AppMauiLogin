...
public partial class Olympikus : ContentPage
{
    Usuario _usuario;
    ...
    public Olympikus(Usuario usuario)
    {
        InitializeComponent();
        _usuario = usuario;
    ...
    private async void olympikus3_Clicked(object sender, EventArgs e)
    {
        await Navigation.PushAsync(new olympikus3());
    }
}